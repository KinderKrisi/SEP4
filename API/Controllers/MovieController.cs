...
namespace API.Controllers
{
    ...
    public class MovieController : ControllerBase
    {
        ...
        public MovieController(CinemaContext context)
        {
            ...
            if (!_context.Movies.Any()) fillDatabase();
        }
        ...
        public IActionResult Update(long id, Movie movie)
        {
            ...
            if (movie.Name != null) _movie.Name = movie.Name;
            if (movie.Length != 0) _movie.Length = movie.Length;
            if (movie.Language != null) _movie.Language = movie.Language;

            if (movie.StartTime != null) _movie.StartTime = movie.StartTime;

            if (movie.Price != 0) _movie.Price = movie.Price;

            if (movie.Seats != null) _movie.Seats = movie.Seats;
        ...
        private void fillDatabase()
        {
            ...
            {
                for (var i = 0; i < 30; i++)
                    _context.Parking.Add(new ParkingPlace {Reserved = false}
                    );
