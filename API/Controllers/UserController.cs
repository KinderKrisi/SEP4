...
namespace API.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public IActionResult Update(long id, User user)
        {
            ...
            if (user.FirstName != null) _user.FirstName = user.FirstName;

            if (user.LastName != null) _user.LastName = user.LastName;
            if (user.PhoneNumber != null) _user.PhoneNumber = user.PhoneNumber;
